...
uses
  ...
  StdCtrls, DBSumLst, Spin, RzTreeVw, System.Generics.Collections;
...
procedure IniTreeDataFast(Tree: TRzCheckTree; SourceSQL: string; qryTemp: TADOQuery);
var
...
begin
  Result := False;
  if NodeName = '' then begin ShowMessageBoxEx('请输入树节点名称！','info'); Exit; end;
  if TableName = '' then begin ShowMessageBoxEx('无法获取表名！','info'); Exit; end;
